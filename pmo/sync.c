                    ...
                    size_t starting_vma_address, bool update_checksum)
{
    ...
    // mm->pmo_stats.psynctime_other_start = ktime_get_ns();
        ...
        PMO_IV_IS_ENABLED())
    {
        ...
        // mm->pmo_stats.psynctime_iv_start = ktime_get_ns();
        // trace_printk("[PSYNC-IV_start: %lld]\n", mm->pmo_stats.psynctime_iv_start);
        ...
        trace_printk("pmo_stats_stop_psynctime_iv: mm=%p\n", mm);
        // atomic64_add((ktime_get_ns() - mm->pmo_stats.psynctime_iv_start), &mm->pmo_stats.psynctime_iv);
    ...
    trace_printk("pmo_stats_stop_psynctime_other: mm=%p\n", mm);
    // mm->pmo_stats.psynctime_other += ktime_get_ns() - mm->pmo_stats.psynctime_other_start;
                       ...
                       struct vpma_area_struct *vpma)
{
    ...
    trace_printk("pmo_stats_start_psynctime_encrypt: mm=%p\n", mm);
    // mm->pmo_stats.psynctime_encrypt_start = ktime_get_ns();
    // trace_printk("[PSYNC-encrypt_start: %lld]\n", mm->pmo_stats.psynctime_encrypt_start);
    ...
    trace_printk("pmo_stats_stop_psynctime_encrypt: mm=%p\n", mm);
    // mm->pmo_stats.psynctime_encrypt += ktime_get_ns() - mm->pmo_stats.psynctime_encrypt_start;
    // trace_printk("[PSYNC-encrypt_elapsed: %lld -> %lld]\n",
    //     mm->pmo_stats.psynctime_encrypt, mm->pmo_stats.psynctime_encrypt + ktime_get_ns() - mm->pmo_stats.psynctime_encrypt_start);
